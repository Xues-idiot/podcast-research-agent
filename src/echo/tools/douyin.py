...
class DouyinDownloader:
    ...
    支持:
    - 抖音视频 (douyin.com/video/xxx)
    - 火山视频 (huoshan.com/xxx)
    """
    ...
    async def download(self, url: str) -> str:
        ...
        ydl_opts = {
            ...
            "outtmpl": str(self.output_dir / "douyin_%(id)s.%(ext)s"),
            "postprocessors": [{
    ...
    def _download_sync(self, url: str, ydl_opts: dict) -> str:
        ...
        try:
            ...
            raise RuntimeError(f"抖音下载失败: {e}")
        except Exception as e:
            raise RuntimeError(f"抖音下载时发生未知错误: {e}")
