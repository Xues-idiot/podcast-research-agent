        ...
        <CardContent>
          <div className="space-y-3">
            ...
            <motion.div
              initial={{ scale: 0.9 }}
              animate={{ scale: 1 }}
              className="flex items-center justify-center p-4 bg-[#2C3E50] text-white rounded-xl font-semibold text-lg shadow-lg"
            >
              {mindmap.root || "主题"}
            </motion.div>

            {/* 分支 */}
            <div className="ml-8 space-y-2 border-l-2 border-[#2C3E50]/20 pl-4">
                ...
                return (
                  <div key={index}>
                    ...
                    <motion.button
                      ...
                      className="flex items-center gap-2 w-full text-left p-2 rounded-lg hover:bg-[#FAF8F5] transition-colors"
                    >
                        ...
                        >
                          {branch.children.map((child, childIndex) => (
                            <motion.div
                              ...
                              className="flex items-center gap-2 p-2 rounded bg-[#FAF8F5] text-sm text-[#2C3E50]/80"
                            >
